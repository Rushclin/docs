...
- **Bulk user registration** - Register multiple users programmatically for enterprise deployments  
- **Third-party integrations** - Allow other platforms to create Genuka accounts for their users
- **Mobile applications** - Enable account creation from mobile apps without redirecting to web forms
