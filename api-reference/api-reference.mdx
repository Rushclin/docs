...
| **Sandbox** | `https://sandbox-api.genuka.com` | Development and testing |
...
<CardGroup cols={2}>
  ...
  <Card title="Complete Documentation" icon="book">
    [docs.genuka.com](https://docs.genuka.com)
  </Card>
  <Card title="Technical Blog" icon="newspaper">
    [notes.genuka.com](https://notes.genuka.com)
  </Card>
